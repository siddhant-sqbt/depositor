...
function Sidebar({
  ...
  if (collapsible === "none") {
    return (
      <div data-slot="sidebar" className={cn("bg-sidebar text-sidebar-foreground flex h-[100dvh-81px] w-(--sidebar-width) flex-col", className)} {...props}>
        {children}
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          // "fixed bottom-0 left-0 z-10 hidden h-[calc(100svh-81px)] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
